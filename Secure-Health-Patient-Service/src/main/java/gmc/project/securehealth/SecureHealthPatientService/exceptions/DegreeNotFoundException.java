...
public class DegreeNotFoundException extends RuntimeException {
	...
	private static final long serialVersionUID = -8818724796977296480L;
	...
	public DegreeNotFoundException(String message, Throwable cause, boolean enableSuppression,
